...
function FrontFigure({ primary, secondary }: { primary: Muscle[]; secondary: Muscle[] }) {
  ...
  return (
    <svg viewBox="0 0 220 520" role="img" aria-label="Front muscle view">
      <BaseBody />
      <path className={cls("neck")} data-muscle="neck" d={capsule(110, 54, 14, 110, 76, 17)} />
      <path className={cls("traps")} data-muscle="traps" d="M60,82 C64,76 82,72 98,73 L92,96 L66,96 Z" />
      <path className={cls("traps")} data-muscle="traps" d="M160,82 C156,76 138,72 122,73 L128,96 L154,96 Z" />
      <ellipse className={cls("front_delts")} data-muscle="front_delts" cx={46} cy={92} rx={19} ry={21} />
      <ellipse className={cls("front_delts")} data-muscle="front_delts" cx={174} cy={92} rx={19} ry={21} />
      <path
        className={cls("chest")}
        data-muscle="chest"
      ...
      />
      <path className={cls("biceps")} data-muscle="biceps" d={capsule(44, 90, 16, 38, 168, 12)} />
      <path className={cls("biceps")} data-muscle="biceps" d={capsule(176, 90, 16, 182, 168, 12)} />
      <path className={cls("forearms")} data-muscle="forearms" d={capsule(36, 184, 12, 29, 272, 9)} />
      <path className={cls("forearms")} data-muscle="forearms" d={capsule(184, 184, 12, 191, 272, 9)} />
      <path className={cls("quads")} data-muscle="quads" d={capsule(86, 256, 22, 78, 368, 15)} />
      <path className={cls("quads")} data-muscle="quads" d={capsule(134, 256, 22, 142, 368, 15)} />
      <path
        className={cls("adductors")}
        data-muscle="adductors"
        d="M98,256 L122,256 C123,284 119,312 112,332 L108,332 C101,312 97,284 98,256 Z"
      />
      <path className={cls("calves")} data-muscle="calves" d={capsule(78, 382, 14, 73, 466, 9)} />
      <path className={cls("calves")} data-muscle="calves" d={capsule(142, 382, 14, 147, 466, 9)} />
      <path
        className="ab-line"
...
function BackFigure({ primary, secondary }: { primary: Muscle[]; secondary: Muscle[] }) {
  ...
  return (
    <svg viewBox="0 0 220 520" role="img" aria-label="Back muscle view">
      ...
      />
      <ellipse className={cls("rear_delts")} data-muscle="rear_delts" cx={46} cy={92} rx={19} ry={21} />
      <ellipse className={cls("rear_delts")} data-muscle="rear_delts" cx={174} cy={92} rx={19} ry={21} />
      <path
        className={cls("lats")}
        data-muscle="lats"
      ...
      />
      <path className={cls("upper_back")} data-muscle="upper_back" d="M92,136 L128,136 L122,176 L98,176 Z" />
      <path
        className={cls("lower_back")}
        data-muscle="lower_back"
        d="M90,182 C100,178 120,178 130,182 L126,220 C112,224 108,224 94,220 Z"
      />
      <path className={cls("triceps")} data-muscle="triceps" d={capsule(44, 90, 16, 38, 168, 12)} />
      <path className={cls("triceps")} data-muscle="triceps" d={capsule(176, 90, 16, 182, 168, 12)} />
      <path className={cls("forearms")} data-muscle="forearms" d={capsule(36, 184, 12, 29, 272, 9)} />
      <path className={cls("forearms")} data-muscle="forearms" d={capsule(184, 184, 12, 191, 272, 9)} />
      <path
      ...
      />
      <path className={cls("hamstrings")} data-muscle="hamstrings" d={capsule(86, 286, 20, 78, 368, 15)} />
      <path className={cls("hamstrings")} data-muscle="hamstrings" d={capsule(134, 286, 20, 142, 368, 15)} />
      <path className={cls("calves")} data-muscle="calves" d={capsule(78, 382, 14, 73, 466, 9)} />
      <path className={cls("calves")} data-muscle="calves" d={capsule(142, 382, 14, 147, 466, 9)} />
    </svg>
  );
